...
classDiagram
  ...
  class OutcomeLog {
    datedObservationsAndSources
    separateAssessmentsAndLimits
    optionalExpectationOutcomePairs
  }
  Context --> ActiveWork : informs
  ActiveWork --> OutcomeLog : may yield selective evidence
```
